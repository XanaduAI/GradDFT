...
mf.xc = 'b3lyp'
ground_truth_energy = mf.kernel()
molecule2e = molecule_from_pyscf(mf, omegas = [0.])

params = freeze({'params': {}})

from constraints import constraint_c6, constraint_x4, constraint_x6, constraint_x7, constraint_xc2, constraint_xc4, constraints_x1_c1, constraint_x2, constraint_c2, constraints_fractional_charge_spin, constraints_x3_c3_c4, constraint_x5
...
print(f'Quadratic loss of the functional B3LYP from the fractional charge & spin constrain (xc1)?', fcs)