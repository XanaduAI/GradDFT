...
class Utils:
    def __init__(self, config_path: str = ""):
        if config_path != "":
            try:
                ...
                raise Exception(
                    "It is necessary to create a configuration file (.json) for some variables"
                )
    ...
    def parse_arguments(self):
        ...
        parser = argparse.ArgumentParser(
            description="Replication of the DM21 paper\n Example: python main.py prediction"
        )
        ...
        parser.add_argument(
            "mode",
            default="predict",
            help="Select one mode from training/evaluation/prediction/test",
            type=str,
        )
